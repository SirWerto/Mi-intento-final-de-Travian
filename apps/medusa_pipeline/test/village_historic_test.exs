...
property "create_village_attr maintains player_id and village_id" do
    forall info <- info_random() do
      ...
      {{player_id_2, village_id_2}, _results} = MedusaPipeline.VillageHistoric.create_village_attrs({{player_id, village_id}, village_logs})
...
property "create_village_attr race don't change over the pipeline" do
    forall info <- info_random() do
      ...
      {{_player_id, _village_id}, results} = MedusaPipeline.VillageHistoric.create_village_attrs({{player_id, village_id}, village_logs})
